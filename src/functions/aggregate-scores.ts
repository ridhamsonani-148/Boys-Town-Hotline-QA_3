...
export const handler = async (event: StepFunctionsEvent): Promise<StepFunctionsEvent> => {
  ...
  try {
    ...
    const fieldMappings: {[key: string]: string} = {
      ...
      'Appropriate Termination (Follow Up Offered)': 'Appropriate Termination',
      'Appropriate Termination (Follow Up)': 'Appropriate Termination',
      'Follow Up Offered': 'Appropriate Termination',
